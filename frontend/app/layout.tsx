...
const interFont = Inter({ subsets: ["latin"], weight: ["300", "400", "500", "600", "700"] })
...
export const metadata: Metadata = {
  title: "Sinhala OCR Converter – PDF & Image to Word",
description: "Convert your PDF and image files to Word documents instantly...",
  icons: {
    icon: "/favicon.png",
  },
}
